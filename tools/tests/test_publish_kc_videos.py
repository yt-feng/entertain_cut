...
class PublishKcVideosTests(unittest.TestCase):
    def test_webdav_url_encodes_chinese_category(self) -> None:
        url = publish.build_webdav_url(
            "https://dav.jianguoyun.com/dav/",
            ["KCdesk", "Ops", "2026-07-13", "KC娱乐"],
        )
        self.assertEqual(
            url,
            "https://dav.jianguoyun.com/dav/KCdesk/Ops/2026-07-13/KC%E5%A8%B1%E4%B9%90/",
        )
